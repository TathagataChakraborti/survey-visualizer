...
x1 = Var('Virtual Design Element (VDE) > Virtual Entities > Robots > Visualization Robots')
x2 = Var('Virtual Design Element (VDE) > Virtual Entities > Robots > Simulated Robots')
x3 = Var('Virtual Design Element (VDE) > Virtual Entities > Robots > Robot Digital Twins')
x4 = Var('Virtual Design Element (VDE) > Virtual Entities > Control Objects > Panels & Buttons')
x5 = Var('Virtual Design Element (VDE) > Virtual Entities > Control Objects > 3D Controllers')
x6 = Var('Virtual Design Element (VDE) > Virtual Entities > Environmental > Simulated Agents')
x7 = Var('Virtual Design Element (VDE) > Virtual Entities > Environmental > Simulated Objects')
x8 = Var('Virtual Design Element (VDE) > Virtual Entities > Environmental > Simulated Environments')
x9 = Var('Virtual Design Element (VDE) > Virtual Entities > Environmental > Object Digital Twins')
x10 = Var('Virtual Design Element (VDE) > Virtual Entities > Environmental > Environment Digital Twins')
x11 = Var('Virtual Design Element (VDE) > Virtual Alterations > Superficial > Cosmetic Alterations')
x12 = Var('Virtual Design Element (VDE) > Virtual Alterations > Superficial > Special Effect Alterations')
x13 = Var('Virtual Design Element (VDE) > Virtual Alterations > Morphological > Body Extensions')
x14 = Var('Virtual Design Element (VDE) > Virtual Alterations > Morphological > Body Diminishments')
x15 = Var('Virtual Design Element (VDE) > Virtual Alterations > Morphological > Form Transformations')
x16 = Var('Virtual Design Element (VDE) > Robot Status Visualizations > Internal > Internal Reading')
x17 = Var('Virtual Design Element (VDE) > Robot Status Visualizations > Internal > Internal Readiness')
x18 = Var('Virtual Design Element (VDE) > Robot Status Visualizations > External > Robot Pose')
x19 = Var('Virtual Design Element (VDE) > Robot Status Visualizations > External > Robot Location')
x20 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Environment > External Sensor Purviews')
x21 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Environment > External Sensor Numerical Readings')
x22 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Environment > External Sensor Images & Videos')
x23 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Environment > External Sensor 3D Data')
x24 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Environment > Sensed Spatial Regions')
x25 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Environment > Robot Inherent Spatial Regions')
x26 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Environment > User-Defined Spatial Regions')
x27 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Entity > Entity Labels')
x28 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Entity > Entity Attributes')
x29 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Entity > Entity Locations')
x30 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Entity > Entity Appearances')
x31 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Task > Headings')
x32 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Task > Waypoints')
x33 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Task > Callouts')
x34 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Task > Spatial Previews')
x35 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Task > Trajectories')
x36 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Task > Alteration Previews')
x37 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Task > Command Options & Validity')
x38 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Task > Task Status')
x39 = Var('Virtual Design Element (VDE) > Robot Comprehension Visualizations > Task > Task Instructions')

all_features = [x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32, x33, x34, x35, x36, x37, x38, x39]
...
custom_constraints, preferences = make_constraints('vamhri_config.txt', lookup_dict, all_features)
