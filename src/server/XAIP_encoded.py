...
x10 = Var('Explanation > Abstraction > Selective')
x11 = Var('Explanation > Addresses Vocabulary Mismatch > Selective')
x12 = Var('Evaluation > User Study > Selective')
x13 = Var('Problem Setting > Deterministic Dynamics > Selective')
x14 = Var('Problem Setting > OverSubscription Setting > Selective')
x15 = Var('Problem Setting > Temporal/Numeric > Selective')
x16 = Var('Problem Setting > Stochastic Dynamics > Selective')
x17 = Var('Problem Setting > Motion Planning > Selective')
x18 = Var('Problem Setting > HTN > Selective')
x19 = Var('Problem Setting > Qualitative Non-Determinism > Selective')
x20 = Var('Problem Setting > Partial Observability > Selective')
x21 = Var('Problem Setting > Reinforcement Learning > Selective')
x22 = Var('Interpretable Behavioral Measures > Explicability > Selective')
x23 = Var('Interpretable Behavioral Measures > Legibility > Selective')
x24 = Var('Interpretable Behavioral Measures > Predictability > Selective')
x25 = Var('Overview/Position Paper > Explanation > Selective')
x26 = Var('Overview/Position Paper > Interpretable Behavioral > Selective')

all_features = [x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21, x22, x23, x24, x25, x26]
...
custom_constraints, preferences = make_constraints('XAIP_config.txt', lookup_dict, all_features)
